...
class sortAlgorithms {
    ...
    BubbleSort = async () => {
        ...
        for(let a = 0; a < this.size; ++a){
            this.list[a].innerHTML = this.list[a].getAttribute("value");
        }
    ...
    InsertionSort = async () => {
        ...
        for(let counter = 0 ; counter < this.size ; ++counter) {
            this.list[counter].innerHTML = this.list[counter].getAttribute("value");
    ...
    MergeSort = async () => {
        ...
        for(let counter = 0 ; counter < this.size ; ++counter) {
            this.list[counter].innerHTML = this.list[counter].setAttribute("value");
            this.list[counter].setAttribute("class", "cell done");
        }
    }
    ...
    Merge = async (start, mid, end) => {
        ...
        for(let c = start ; c <= end ; ++c) {
            this.list[c].innerHTML = this.list[c].getAttribute("value");
